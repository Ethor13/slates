...
export const BenefitsForBars = () => {
  return (
    <section className="relative pt-24 bg-gradient-to-b from-slate-900 via-70% via-slate-medium to-slate-light to-100%" aria-labelledby="benefits-heading">
      <div className="relative mx-auto max-w-7xl px-6 flex flex-col gap-8 sm:gap-16">
        ...
        <div className='flex flex-row'>
          <div className="my-auto flex-1 hidden sm:block">
          ...
          <ul className="grid grid-cols-1 gap-4 flex-1 sm:ml-8" >
            {BENEFITS.map(b => {
              const Icon = b.icon;
              return (
                <li
