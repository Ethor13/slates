...
import { scrapeUrl, combine_maps} from "../helpers";
...
export async function updateScheduleInFirestore(db: Firestore, batch: WriteBatch, date: string, sport: string): Promise<void> {
    try {
