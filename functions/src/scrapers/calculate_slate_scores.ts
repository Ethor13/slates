...
import { combine_maps, deepMerge } from "../helpers.js";
...
interface CategoryConfig {
  ...
  getGameMetricsFunc: (date: string, sport: string, db: Firestore) => Promise<Record<string, any>>;
 ...
 */
async function getScheduleData(date: string, sport: string, db: Firestore): Promise<Record<string, any>> {
 ...
 */
async function getGameMetricsAllData(date: string, sport: string, db: Firestore): Promise<Record<string, any>> {
  // Check if data exists in Firestore
 ...
 */
export async function scoreSportsGames(
